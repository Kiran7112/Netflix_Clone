...
function Crime() {
    ...
    const api_url = `https://api.themoviedb.org/3/discover/tv?api_key=${api}&language=en-US&with_genres=80`;
    ...
    return (
        <>
            <section className='pop-con' id='crimetv'>
                <p className='popular-text'>Crime Shows</p>
