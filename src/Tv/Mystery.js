...
function Mystery() {
    ...
    const api_url = `https://api.themoviedb.org/3/discover/tv?api_key=${api}&language=en-US&with_genres=9648`;
    ...
    return (
        <>
            <section className='pop-con' id='mysterytv'>
                <p className='popular-text'>Mystery Shows</p>
