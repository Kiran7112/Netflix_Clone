...
function Family() {
    ...
    const api_url = `https://api.themoviedb.org/3/discover/tv?api_key=${api}&language=en-US&with_genres=10751`;
    ...
    return (
        <>
            <section className='pop-con' id='familytv'>
                <p className='popular-text'>Family Shows</p>
