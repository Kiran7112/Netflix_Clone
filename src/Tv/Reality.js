...
function Reality() {
    ...
    const api_url = `https://api.themoviedb.org/3/discover/tv?api_key=${api}&language=en-US&with_genres=10764`;
    ...
    return (
        <>
            <section className='pop-con' id='realitytv'>
                <p className='popular-text'>Reality Shows</p>
