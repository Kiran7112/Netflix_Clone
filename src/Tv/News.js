...
function News() {
    ...
    const api_url =  `https://api.themoviedb.org/3/discover/tv?api_key=${api}&language=en-US&with_genres=10763`;
    ...
    return (
        <>
            <section className='pop-con' id='newstv'>
                <p className='popular-text'>News Shows</p>
