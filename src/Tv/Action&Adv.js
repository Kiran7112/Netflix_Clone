...
function Action_Adv() {
    ...
    const youtubeBaseUrl = "https://www.googleapis.com/youtube/v3/search";
      ...
      const api_url = `https://api.themoviedb.org/3/discover/tv?api_key=${api}&language=en-US&with_genres=10759`;
    ...
    return (
        <>
            <section className='pop-con' id='actiontv'>
                <p className='popular-text'>Action and Adventure Shows</p>
