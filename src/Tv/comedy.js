...
function Comedy_Shows() {
    ...
    const api_url = `https://api.themoviedb.org/3/discover/tv?api_key=${api}&language=en-US&with_genres=35`;
    ...
    return (
        <>
            <section className='pop-con' id='comedytv'>
                <p className='popular-text'>Comedy Shows</p>
