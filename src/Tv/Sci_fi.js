...
function  Sci_Fi() {
    ...
    const api_url = `https://api.themoviedb.org/3/discover/tv?api_key=${api}&language=en-US&with_genres=10765`;
    ...
    return (
        <>
            <section className='pop-con' id='sci-fi'>
                <p className='popular-text'> Sci-Fi Shows</p>
