...
function  War_Politics() {
    ...
    const api_url =  `https://api.themoviedb.org/3/discover/tv?api_key=${api}&language=en-US&with_genres=10768`;
    ...
    return (
        <>
            <section className='pop-con' id='wartv'>
                <p className='popular-text'> War and Politics Shows</p>
