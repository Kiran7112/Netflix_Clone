...
function Western() {
    ...
    const api_url =   `https://api.themoviedb.org/3/discover/tv?api_key=${api}&language=en-US&with_genres=37`;
    ...
    return (
        <>
            <section className='pop-con'id='westerntv'>
            <p className='popular-text'> Western Shows</p>
