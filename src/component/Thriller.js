...
function Thriller() {
    ...
    const apiUrl = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&language=en-US&with_genres=53`;
    ...
    return (
        <>
            <section className='pop-con' id='thriller'>
                <p className='popular-text'>Thriller Movies</p>
