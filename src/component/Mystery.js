...
function Mystery() {
    ...
    const apiUrl = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&language=en-US&with_genres=9648`;
    ...
    return (
        <>
            <section className='pop-con' id='mystery'>
                <p className='popular-text'>Mystery Movies</p>
                <div className='pop-box-cont'>
                    {mysteryMovies.map((details, index) => ( 
