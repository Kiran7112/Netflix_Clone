...
function TeluguRomantic() {
    const [teluguMovies, setTeluguMovies] = useState([]);
    const [trailer, setTrailer] = useState("");
    const api = "cf9f8c36866c23046aad7733bb2641eb";   
    const api_url = `https://api.themoviedb.org/3/discover/movie?api_key=${api}&language=te-IN&region=IN&with_original_language=te&with_genres=10749`;
    ...
    return (
        <>
            <section className='pop-con' id='action'>
                <p className='popular-text'> Heartfelt In Telugu</p>
