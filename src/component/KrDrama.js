...
function  KrDrama() {
    ...
    const api_url = `https://api.themoviedb.org/3/discover/tv?api_key=${api}&language=ko-KR&region=KR&with_original_language=ko&with_genres=80`;
    ...
    return (
        <>
            <section className='pop-con' id='koreon'>
                <p className='popular-text'>Critically Acclaimed Exciting KDrama </p>
