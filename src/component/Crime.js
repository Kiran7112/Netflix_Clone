...
function Crime() {
    ...
    const apiUrl = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&language=en-US&with_genres=80`;
    ...
    return (
        <>
            <section className='pop-con' id='crime'>
                <p className='popular-text'>Crime Movies</p>
                <div className='pop-box-cont'>
                    {crimeMovies.map((details, index) => ( 
