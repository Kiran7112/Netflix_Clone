...
function War() {
    ...
    const apiUrl = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&language=en-US&with_genres=10752`;
    ...
    return (
        <>
            <section className='pop-con' id='war'>
                <p className='popular-text'>War Movies</p>
                <div className='pop-box-cont'>
                    {warMovies.map((details, index) => ( 
