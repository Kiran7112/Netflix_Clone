...
function History() {
    ...
    const apiUrl = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&language=en-US&with_genres=36`;
    ...
    return (
        <>
            <section className='pop-con' id='history'>
                <p className='popular-text'>History Movies</p>
                <div className='pop-box-cont'>
                    {historyMovies.map((details, index) => ( 
