...
function Adventure() {
    ...
    const apiUrl = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&language=en-US&with_genres=12`;
    ...
    return (
        <>
            <section className='pop-con' id='adv'>
                <p className='popular-text'>Adventure Movies</p>
                <div className='pop-box-cont'>
                    {adventureMovies.map((details, index) => ( 
