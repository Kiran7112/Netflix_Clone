...
function Popular() {
    ...
    const api_url = `https://api.themoviedb.org/3/discover/tv?api_key=${api}&with_networks=213`;
    ...
    return (
        <>
            <section className='pop-con' id='popular'>
                <p className='popular-text'>NETFLIX ORIGINALS</p>
                <div className='pop-box-cont'>
                    {popsearch.map((details, index) => (
                        <>
                        <div key={index} className="pop_box" style={{backgroundImage: `url(https://image.tmdb.org/t/p/w500/${details.poster_path})`, backgroundSize: 'cover',objectPosition:'center',backgroundPosition:' center -5px'}}>
