...
function Horror() {
    ...
    const apiUrl = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&language=en-US&with_genres=27`;
    ...
    return (
        <>
            <section className='pop-con' id='horror'>
                <p className='popular-text'>Horror Movies</p>
                <div className='pop-box-cont'>
                    {horrorMovies.map((details, index) => ( 
