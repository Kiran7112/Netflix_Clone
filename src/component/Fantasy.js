...
function Fantasy() {
    ...
    const apiUrl = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&language=en-US&with_genres=14`;
    ...
    return (
        <>
            <section className='pop-con' id='fantasy'>
                <p className='popular-text'>Fantasy</p>
                <div className='pop-box-cont'>
                    {fantasyMovies.map((details, index) => ( 
