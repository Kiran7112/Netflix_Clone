...
function Drama() {
    ...
    const apiUrl = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&language=en-US&with_genres=18`;
    ...
    return (
        <>
            <section className='pop-con' id='drama'>
                <p className='popular-text'>Drama Movies</p>
                <div className='pop-box-cont'>
                    {dramaMovies.map((details, index) => ( 
