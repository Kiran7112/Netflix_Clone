...
function Music() {
    ...
    const apiUrl = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&language=en-US&with_genres=10402`;
    ...
    return (
        <>
            <section className='pop-con' id='music'>
                <p className='popular-text'>Music Movies</p>
                <div className='pop-box-cont'>
                    {musicMovies.map((details, index) => ( 
