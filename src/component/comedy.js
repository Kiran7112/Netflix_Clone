...
function TeluguMovies() {
    ...
    const api_url = `https://api.themoviedb.org/3/discover/movie?api_key=${api}&language=te-IN&region=IN&with_original_language=hi&with_genres=35`; 
    ...
    return (
        <>
            <section className='pop-con' id='comedy'>
                <p className='popular-text'>More Fun</p>
