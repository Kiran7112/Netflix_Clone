...
function TeluguMovies() {
    ...
    const api_url = `https://api.themoviedb.org/3/discover/movie?api_key=${api}&language=te-IN&region=IN&with_original_language=te&with_genres=28`;
    ...
    return (
        <>
            <section className='pop-con' id='action'>
                <p className='popular-text'>Action In Telugu</p>
