...
function Romance() {
    ...
    const apiUrl = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&with_genres=10749`;
    ...
    return (
        <>
            <section className='pop-con' id='romantic'>
                <p className='popular-text'>Romantic Movies</p>
                <div className='pop-box-cont'>
                    {romanticMovies.map((details, index) => ( 
